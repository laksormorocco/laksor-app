...
export async function PATCH(req: Request) {
  try {
    ...
    const data: any = {};
    const allowed = ["title","description","duration","groupSize","difficulty","city","meetingPoint","status","isActive","transportRequired","photos","tags","included","notIncluded","pricePerPerson","price","groupThreshold1","groupDiscount1","groupThreshold2","groupDiscount2","itinerary","pricePerPerson","privatePricePerPerson"];
