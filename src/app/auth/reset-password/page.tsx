    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{background:"#F6F1E8"}}>
      <div className="w-full max-w-sm">
        <div className="text-center mb-6">
          <div className="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-4" style={{background:"rgba(184,138,68,0.1)"}}>
          ...
          <p className="text-sm text-charcoal-400 mt-1">Choisissez un nouveau mot de passe</p>
        </div>
        <div className="bg-white rounded-2xl p-5 flex flex-col gap-3" style={{boxShadow:"0 2px 16px rgba(0,0,0,0.06)"}}>
          <input type="password" value={password} onChange={e => setPassword(e.target.value)}
            ...
            className="w-full border-2 border-sand-300 rounded-xl px-4 py-3 text-sm outline-none bg-sand-100 focus:border-bronze-500" />
